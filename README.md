# Proyecto Intermodular de 2º ASIR
**Curso 2025|26**

En este repositorio se encuentra centralizada toda la información relativa al **Proyecto Intermodular de Administración de Sistemas Informáticos en Red del CPIFP Alan Turing**, en la convocatoria del curso 2025|26.

## Requisitos y criterios a seguir

Tanto los criterios generales como los criterios particulares por cada módulo se encuentran en [la Wiki de este repositorio](https://github.com/CPIFPAlanTuring/2asir-proyecto-intermodular-2526/wiki) así como la rúbrica de evaluación y calificación.
...
* **10: Plataforma de virtualización centralizada para entornos educativos con Proxmox VE** - Esther Estefany Cruz Nina
    ...
    - [Checkpoint](https://drive.google.com/file/d/1-hb_2Ml3XoLKBVx6sKL-OlCFUXpJWoXE/view?usp=sharing)
    - [2º Checkpoint](https://drive.google.com/file/d/1DsB5h9cxvgAOEx5OnLEwAfmB1bUCYQSx/view?usp=sharing)
    - [Video final](https://)
...
* **12: Automatización de procesos RRHH y ERP** - Ignacio Domínguez Díaz
    ...
    - ***Presentación FFEOE: QUANTIA***
        ...
        <a href="https://" target="_blank">
          <img src="img/quantia.png" alt="Presentación FFEOE: QUANTIA" height="20px">
        </a>
...
* **13: Sistema de gestión integral para gimnasios** - Javier Aguilar Postigo
    ...
    - ***Presentación FFEOE: Babel***
        ...
        <a href="https://" target="_blank">
          <img src="img/babel.png" alt="Presentación FFEOE: Babel" height="30px">
        </a>
